...
DBLocPlus.ZONES = {
    ...
    [PFLP_REALZONENAME_SCARLETMONASTERYARMORYFAKE] = { 30, 45, DC.EK, 0, DS.Contested, false, false, false, nil },
...
DBLocPlus.INSTANCES = {
    ...
    [PFLP_REALZONENAME_EMERALDSANCTUM] = { 60, 60, DC.KLMDR, DIT.Raid, DIS.FortyMan, true, DP.ES, true, nil },
    [PFLP_REALZONENAME_FROSTMANEHOLLOW] = { 13, 20, DC.EK, DIT.Dungeon, DIS.FiveMan, true, nil, true, nil },
    ...
    [PFLP_DISPLAYNAME_SCARLETMONASTERYARMORY] = { 34, 42, DC.EK, DIT.Dungeon, DIS.FiveMan, true, nil, false, PFLP_REALZONENAME_SCARLETMONASTERYARMORY },
